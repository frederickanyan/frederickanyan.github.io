...
This approach is, however, heavily criticized and has a rather bad reputation even until today, and started with [Cronbach & Furby, 1970, p. 68]([https://psycnet.apa.org/doi/10.1037/h0029382)
...
summary(arM)
```
The Intercept (0.83) is the expected value of loneliness at T2 for an individual with a score of 0 = at T1. The slope of loneT1 (0.31) indicates the stability of between-person differences from T1 to T2, which is relatively stable between the two time points as the autoregressive coefficient is not high. We expect a positive difference of (0.31) in loneliness at T2 for a every unit change in loneliness at T1
